                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row my-5">
                                        <div class="col-lg-6 m-auto my-5 p-1" style="border: 1px solid #dcd8d8;border-radius: 10px">
                                            <div class="panel panel-default credit-card-box">
                                                <div class="panel-heading display-table" >
                                                    <div class="row display-tr" >
                                                        <h3 class="panel-title display-td" >Payment Details</h3>
                                                        <div class="display-td" >
                                                            <img class="img-responsive pull-right" class="" style="width: 100px;" src="https://cdn.worldvectorlogo.com/logos/mastercard-6.svg">
                                                        </div>
                                                    </div>
                                                </div>
